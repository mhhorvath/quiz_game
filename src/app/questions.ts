...
export const questions: Array<Question> = [
  ...
  
  {
    ...
    options: [
      ...
      { text: "Curious", vec: [2, 5, 0, 5, -9, 7, 4, 2, 1, 0]},
      { text: "If I must (still curious)", vec: [0, -8, -8, 8, 0, 6, 8, 1, 0, 5]},
    ],
  },
  {
    id:10,
  ...
  },
  {
    ...
    options: [
      { text: "...", vec: [3, 0, 5, 7, -2, 7, 7, -3, 2, 1]},
      { text: "./.", vec: [-1, 5, 1, 9, -9, 5, 2, -1, 3, -6] },
      { text: "// .. ", vec: [-7, -3, 2, 1, 4, -8, 5, 5, -4, 2]},
      { text: ".", vec: [1, 2, 3, -4, -5, 6, 7, -8, -9, 4, 1] },
    ],
  },
];